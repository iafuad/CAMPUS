...
#             return redirect("lost_found_post_detail", post_id=post.id)
#     else:
...
#     return render(
#         request, "lost_found/post_detail.html", {"post": post, "claim_form": claim_form}
#     )
...
#                 user=request.user, found_post=post
#             ).exists()
#             if existing_claim:
#                 messages.warning(
#                     request, "You have already submitted a claim for this item."
#                 )
#                 return redirect("lost_found_post_detail", post_id=post.id)
...
#             c_status, _ = ClaimRequestStatus.objects.get_or_create(name="Pending")
#             claim.status = c_status
#             claim.save()

#             messages.success(
#                 request, "Your claim request has been successfully submitted."
#             )
#             return redirect("lost_found_post_detail", post_id=post.id)
